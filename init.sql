...
CREATE TABLE MEMBERS (
    ...
    EMAIL VARCHAR2(128) CONSTRAINT MEMBER_EMAIL_UK UNIQUE,
    BANK_ACCOUNT_NUMBER VARCHAR2(15) NOT NULL,
    BANK_ROUTING_NUMBER VARCHAR2(10) NOT NULL,
    BANK_NAME VARCHAR2(128) NOT NULL,
    BANK_COUNTRY VARCHAR2(50) NOT NULL
);
...
-- Insert Member with Canadian bank details (random data)
INSERT INTO MEMBERS (
    FIRST_NAME,
    LAST_NAME,
    PHONE,
...
INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Tech Conference 2023', 'Annual technology conference with industry leaders', null, 'Technology', TO_DATE('2023-11-15 09:00', 'YYYY-MM-DD HH24:MI'), 'Convention Center', 500, 250, 199, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Jazz Night', 'An evening of smooth jazz with local artists', null, 'Music', TO_DATE('2023-12-05 19:30', 'YYYY-MM-DD HH24:MI'), 'Downtown Club', 150, 75, 35, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Startup Pitch Competition', 'Local startups pitch to investors', null, 'Business', TO_DATE('2023-11-22 13:00', 'YYYY-MM-DD HH24:MI'), 'Innovation Hub', 200, 120, 50, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Yoga Retreat', 'Weekend yoga and meditation retreat', null, 'Wellness', TO_DATE('2023-12-10 08:00', 'YYYY-MM-DD HH24:MI'), 'Mountain Resort', 100, 40, 120, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Food Festival', 'Taste cuisine from around the world', null, 'Food', TO_DATE('2023-11-25 11:00', 'YYYY-MM-DD HH24:MI'), 'City Park', 1000, 800, 15, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Coding Workshop', 'Hands-on coding workshop for beginners', null, 'Education', TO_DATE('2023-12-03 10:00', 'YYYY-MM-DD HH24:MI'), 'Tech Campus', 30, 15, 75, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Art Exhibition', 'Contemporary art from local artists', null, 'Art', TO_DATE('2023-11-18 10:00', 'YYYY-MM-DD HH24:MI'), 'Art Gallery', 300, 150, 20, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Marathon', 'Annual city marathon', null, 'Sports', TO_DATE('2023-12-17 07:00', 'YYYY-MM-DD HH24:MI'), 'City Center', 5000, 3500, 30, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Book Reading', 'Author reading and book signing', null, 'Literature', TO_DATE('2023-11-30 18:00', 'YYYY-MM-DD HH24:MI'), 'Central Library', 80, 45, 10, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Wine Tasting', 'Premium wine tasting event', null, 'Food', TO_DATE('2023-12-09 17:00', 'YYYY-MM-DD HH24:MI'), 'Vineyard Estate', 50, 25, 85, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Comedy Night', 'Stand-up comedy show', null, 'Entertainment', TO_DATE('2023-11-20 20:00', 'YYYY-MM-DD HH24:MI'), 'Comedy Club', 120, 90, 25, 1, SYSDATE);

INSERT INTO EVENTS (TITLE, DESCRIPTION, IMAGE_PATH, CATEGORY, DATE_TIME, LOCATION, TOTAL_TICKETS, TICKETS_SOLD, PRICE_PER_TICKET, MEMBER_ID, CREATED_AT)
VALUES ('Science Fair', 'Interactive science exhibits for all ages', null, 'Education', TO_DATE('2023-12-12 09:00', 'YYYY-MM-DD HH24:MI'), 'Science Museum', 400, 200, 12, 1, SYSDATE);
